						...
						<div class="card-body">
							...
							<div class="row">
								...
								<?php if (isset($config['product'][$type]['tinhtrang']) && $config['product'][$type]['tinhtrang'] == true) { ?>
									<div class="form-group col-md-12">
										<label class="d-block" for="tinhtrang">Tình trạng:</label>
										<div class="input-group">
											<input type="text" class="form-control" name="data[tinhtrang]" id="tinhtrang" placeholder="Tình trạng" value="<?= @$item['tinhtrang'] ?>">
								...
								<?php if (isset($config['product'][$type]['baohanh']) && $config['product'][$type]['baohanh'] == true) { ?>
									<div class="form-group col-md-12">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="data[baohanh]" id="baohanh" placeholder="Bảo hành" value="<?= @$item['baohanh'] ?>">
